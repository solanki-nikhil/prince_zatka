                                        ...
                                        <form id="product_form" class="form" action="javascript:void(0);" method="POST">
                                             <div class="row">
                                                  ...
                                                  <div class="col-md-4 col-12 mb-1">
                                                       ...
                                                       @if((isset($product) && isset($product->image2)))
                                                       <img class="mt-1 rounded" src="{{asset('upload/product/'.$product->image2)}}" height="100" width="100">
                                                       @endif
                                                  </div>
                                                  <div class="col-md-4 col-12 mb-1">
                                                       <label for="image3" class="form-label">Image 3 (optional)</label>
                                                       <input class="form-control" type="file" id="image3" name="image3">
                                                       @if((isset($product) && isset($product->image3)))
                                                       <img class="mt-1 rounded" src="{{asset('upload/product/'.$product->image3)}}" height="100" width="100">
                                                       @endif
                                                  </div>
                                                  ...
                                                  <div class="col-md-4 col-12 mb-1 custom-input-group">
                                                       ...
                                                       <input type="number" class="form-control" name="price" id="price" placeholder="Price" value="{{ ((isset($product) && isset($product->price)) ? $product->price : old('price'))  }}">
...
<script type="text/javascript">
     ...
     $(document).ready(function() {
          $('.save-product').on('click', function() {
               ...
               if ($("#category_id").val() != "" && $("#product_name").val() != "" && $("#product_code").val() != "" && $("#box").val() != "" && $("#price").val() != "" && $("#box").val() >= 1 && $("#price").val() >= 0) {
                    $.ajax({
                         type: "POST",
